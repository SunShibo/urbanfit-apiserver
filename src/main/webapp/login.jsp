...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/manage/login.js"></script>
</head>
<body style="overflow:hidden; width:100%; height:100%;">
    <div id="web_bg" style="position:absolute; width:100%; height:100%; z-index:-1">
        <img src="${pageContext.request.contextPath}/static/img/bg.jpg" height="100%" width="100%" />
    </div>
    <div class="index clear">
        <div class="login" style="margin-top:200px;">
            <img src="${pageContext.request.contextPath}/static/img/bbg.png">
            <ul>
