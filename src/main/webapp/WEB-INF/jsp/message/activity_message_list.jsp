...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/manage/activity_message_list.js"></script>
</head>
<body>
    <div class="index clear">
        <jsp:include page="../main.jsp"></jsp:include>
        <div class="indexRight1">
            <div class="title">活动资讯 > 活动资讯列表</div>
            <form id="activityMessageForm" action="list" method="post">
                <div class="screen clear">
                    ...
                    <a href="javascript:void(0);" id="B_add">新建资讯</a>
                </div>
                <div class="tablebox1">
